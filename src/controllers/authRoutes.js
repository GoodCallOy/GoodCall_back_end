...
exports.getCallback = [
    ...
    (req, res) => {
        ...
        // Generate JWT token
        const JWTtoken = jsonwebtoken_1.default.sign({ id: user._id, email: user.email, avatar: user.avatar, name: user.name, role: user.role, agentId: user.agentId }, process.env.JWT_SECRET, { expiresIn: '7d' });
