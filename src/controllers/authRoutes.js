...
exports.getCallback = [
    ...
    (req, res) => {
        ...
        // Generate JWT token
        const JWTtoken = jsonwebtoken_1.default.sign({ id: user._id, email: user.email, avatar: user.avatar, name: user.name, role: user.role, linkedUserId: user.linkedUserId }, process.env.JWT_SECRET, { expiresIn: '7d' });
...
const isAuthenticated = (req, res) => {
    ...
    try {
        ...
        console.warn('Auth /me: invalid token', { error: err === null || err === void 0 ? void 0 : err.message });
